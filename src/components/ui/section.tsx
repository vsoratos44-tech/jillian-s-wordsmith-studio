...
export function Section({
  ...
  return <section id={id} className={cn("py-16 md:py-24", variant === "muted" && "bg-muted", variant === "primary" && "bg-primary text-primary-foreground", className)}>
...
export function SectionHeader({
  ...
  return <div className={cn("mb-12 md:mb-16", align === "center" && "text-center", className)}>
      ...
      {subtitle && <p className="mt-4 max-w-2xl text-lg text-muted-foreground mx-auto">
          {subtitle}
        </p>}
    </div>;
}